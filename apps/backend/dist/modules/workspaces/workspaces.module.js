...
const workspace_invitation_entity_1 = require("./entities/workspace-invitation.entity");
const workspace_kanban_setting_entity_1 = require("./entities/workspace-kanban-setting.entity");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([
                ...
                workspace_invitation_entity_1.WorkspaceInvitation,
                workspace_kanban_setting_entity_1.WorkspaceKanbanSetting,
            ]),
        ],
